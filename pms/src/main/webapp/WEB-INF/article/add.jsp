	...
	<article class="page-container">
		<form action="articleadd.do" method="post"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" placeholder="" id="author"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9" style="height: 200px;">
					<textarea type="textarea" class="" value="" placeholder="" id="content"
						name="content" style="height: 200px; width: 400px;" onblur="chkContent()"></textarea><span
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" placeholder="" id="isr"
