...
<article class="page-container">
	<form action="adupdate.do?id=${ad.id }" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${ad.title }" placeholder="" id="title" name="title" onblur="chkTitle()">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="height: 200px;">
				<textarea type="textarea" class="" placeholder="" id="content" onblur="chkContent()" name="content" style="height: 200px;width: 400px;">${ad.content }</textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<input type="text" onfocus="WdatePicker({ minDate:'#F{$dp.$D(\'datemin\')}',maxDate:'%y-%M-%d' })" id="datemax" class="input-text Wdate" name="crtime" style="width:120px;" value="${ad.crtime }" >
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input type="submit" value="提交" style="width:70px;height: 40px;background: gray;border-radio:50%;"/>
			</div>
		</div>
	</form>
</article>
